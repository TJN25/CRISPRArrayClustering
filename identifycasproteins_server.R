...
setwd('/home/tomn/masters/Working')
...
write.table(a.uniq, 'uids_matched_with_multiple_cas_models_bacteria_refseq_79.txt', quote = F, row.names = F)
write.table(genes.dat, 'cas_protein_data_bacteria_refseq_79.txt', quote = F, row.names = F, sep = '\t')
write.table(genomes.dat, 'genomes_with_cas_proteins_bacteria_refseq_79.txt', quote = F, row.names = F, sep = '\t')
write.table(genomes.dat[genomes.dat[,4]==T, ], 'genomes_with_single_system_bacteria_refseq_79.txt', quote = F, row.names = F, sep = '\t')
